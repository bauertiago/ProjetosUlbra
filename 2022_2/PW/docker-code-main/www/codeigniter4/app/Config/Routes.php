...
$routes->get('/insertClientAction', 'Client::insertClientAction');
...
$routes->add('/admin/getClientsForAction', 'Admin\Client::getClientsForAction');

//Produtos
$routes->add('/admin/listProducts', 'Admin\Product::listProducts');
$routes->add('/admin/insertProduct', 'Admin\Product::insertProduct');
$routes->add('/admin/insertProductAction', 'Admin\Product::insertProductAction');
$routes->add('admin/updateProduct/(:num)', 'Admin\Product::updateProduct/$1');
$routes->add('admin/updateProductAction/(:num)', 'Admin\Product::updateProductAction/$1');
$routes->add('admin/deleteProduct/(:num)', 'Admin\Product::deleteProduct/$1');



//api
$routes->get('/Api/Client', 'Api\Client::listClientsApi');
