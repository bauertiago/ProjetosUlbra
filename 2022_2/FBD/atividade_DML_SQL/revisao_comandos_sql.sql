-- mostrar todos os produtos que foram pedidos no mes de out/2022
categorias(id, nome)
clientes(id, nome)
...
Select  pd.id, pd.descricao, pi.valor_unit, pi.qtd, p.data
...
-- todos os produtos e os que tem pedidos, me mostre o codigo do pedido
